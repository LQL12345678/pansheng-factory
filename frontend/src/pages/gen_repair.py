          ...
          <tbody>
            {list.map(d => <tr key={d.id} className="tr-detail">
              ...
              <td className="td-action">
                ...
                <button className="danger btn-sm" onClick={async () => { if (window.confirm('确认删除?')) { await repairApi.delete(String(d.id)); load(); } }}>删除</button>
              </td>
            </tr>)}
          </tbody>
        </table>
          ...
          <div className="modal" onClick={e => e.stopPropagation()}>
            ...
            <form onSubmit={handleSubmit}>
              <div className="form-grid">
                ...
                <div style={{ gridColumn: '1/-1' }}><label>故障描述*</label><input name="fault_desc" value={formData.fault_desc || ''} onChange={handleInputChange} required /></div>
...
filepath = r'C:\Users\Admin\WorkBuddy\2026-05-10-task-1\frontend\src\pages\RepairList.tsx'
